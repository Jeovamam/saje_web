...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen pb-32 px-6 bg-background-dark max-w-md mx-auto relative">
      ...
      <nav className="fixed bottom-6 left-6 right-6 h-20 bg-background-dark/50 backdrop-blur-md border border-white/10 rounded-[2.5rem] flex items-center justify-between px-10 shadow-2xl z-50">
