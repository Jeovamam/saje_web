...
export default function NewTransaction() {
  ...
  // 🚀 AUTOMAÇÃO: Muda a Natureza ao selecionar ícone
    ...
    <div className="min-h-screen bg-gradient-main text-slate-100 font-display flex justify-center no-scrollbar overflow-y-auto selection:bg-primary selection:text-background-dark">
      <div className="relative flex h-full min-h-screen w-full max-w-md flex-col bg-transparent border-x border-white/5">
        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col px-6 pb-12 space-y-8">
          ...
          {/* Categorias Dinâmicas (Água, Energia, Internet...) */}
          <div className="space-y-4">
            ...
            <div className="flex w-full overflow-x-auto no-scrollbar gap-5 pb-2 min-h-[90px]">
              {categories.length > 0 ? (
                ...
                <div className="w-full text-center py-6 border border-dashed border-white/10 rounded-2xl">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex h-11 bg-white/5 rounded-xl p-1 border border-white/10">
                  <button
                    ...
                    className={`flex-1 rounded-lg text-[9px] font-black uppercase ${nature === 'variable' ? 'bg-slate-700 text-primary shadow-lg' : 'text-slate-500'}`}
                  >
                    Variável
                  </button>
                  <button
                    ...
                    className={`flex-1 rounded-lg text-[9px] font-black uppercase ${nature === 'fixed' ? 'bg-slate-700 text-primary shadow-lg' : 'text-slate-500'}`}
                  >
                    Fixo
                  </button>
                </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full glass rounded-2xl py-5 px-6 outline-none text-sm"
              />
            </div>

            {/* 🔴 RESPONSÁVEL (ESCRITO UM A UM) */}
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-4 rounded-2xl border transition-all ${paidBy === 'me' ? 'bg-primary/10 border-primary text-primary shadow-neon-soft' : 'glass border-white/5 text-slate-500'}`}
                >
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-4 rounded-2xl border transition-all ${paidBy === 'partner' ? 'bg-primary/10 border-primary text-primary shadow-neon-soft' : 'glass border-white/5 text-slate-500'}`}
                >
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-4 rounded-2xl border transition-all ${paidBy === 'shared' ? 'bg-primary/10 border-primary text-primary shadow-neon-soft' : 'glass border-white/5 text-slate-500'}`}
                >
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-4 gap-2">
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-3 rounded-xl border transition-all ${paymentMethod === 'pix' ? 'bg-primary/20 border-primary text-primary' : 'glass border-white/5 text-slate-500'}`}
                >
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-3 rounded-xl border transition-all ${paymentMethod === 'debit' ? 'bg-primary/20 border-primary text-primary' : 'glass border-white/5 text-slate-500'}`}
                >
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-3 rounded-xl border transition-all ${paymentMethod === 'credit' ? 'bg-primary/20 border-primary text-primary' : 'glass border-white/5 text-slate-500'}`}
                >
                ...
                <button
                  ...
                  className={`flex flex-col items-center gap-2 p-3 rounded-xl border transition-all ${paymentMethod === 'cash' ? 'bg-primary/20 border-primary text-primary' : 'glass border-white/5 text-slate-500'}`}
                >
